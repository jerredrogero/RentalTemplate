...
routes.route(routeNames.getOwnerProperties).get(authJwt.verifyToken, propertyController.getOwnerProperties)
...
routes.route(routeNames.settings).get(propertyController.getSettings)
