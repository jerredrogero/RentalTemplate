...
export const LoginSocialGithub = ({ state = '', scope = 'user.info.basic', client_key, 
// client_secret,
className = '', redirect_uri, 
...
onResolve, onLoginStart, }) => {
    ...
    const onLogin = useCallback(() => {
        ...
        const oauthUrl = `${TIKTOK_URL}/auth/authorize?client_key=${client_key}&scope=${scope}&state=${state + '_tiktok'}&redirect_uri=${redirect_uri}&response_type=code`;
        const width = 450;
        const height = 730;
