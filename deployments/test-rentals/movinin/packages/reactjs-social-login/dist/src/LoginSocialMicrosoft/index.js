...
export const LoginSocialMicrosoft = ({ tenant = 'common', state = '', client_id, className, redirect_uri, scope = 'profile openid email', response_type = 'code', response_mode = 'query', children, code_challenge = '19cfc47c216dacba8ca23eeee817603e2ba34fe0976378662ba31688ed302fa9', code_challenge_method = 'plain', prompt = 'select_account', isOnlyGetCode = false, isOnlyGetToken = false, onLoginStart, onReject, onResolve, }) => {
    useEffect(() => {
    ...
    const onLogin = useCallback(() => {
        ...
        window.open(oauthUrl, 'Microsoft', 'menubar=no,location=no,resizable=no,scrollbars=no,status=no, width=' +
            width +
            ', height=' +
            height +
            ', top=' +
