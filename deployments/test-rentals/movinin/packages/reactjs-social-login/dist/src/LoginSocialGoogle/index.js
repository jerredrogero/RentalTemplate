...
const LoginSocialGoogle = ({ client_id, scope = 'https://www.googleapis.com/auth/userinfo.profile', prompt = 'select_account', typeResponse = 'accessToken', ux_mode, className = '', login_hint = '', access_type = 'online', onLoginStart, onReject, onResolve, redirect_uri = '/', auto_select = false, isOnlyGetToken = false, cookie_policy = 'single_host_origin', hosted_domain = '', discoveryDocs = '', children, fetch_basic_profile = true, }) => {
    ...
    return (React.createElement("div", { className: className, onClick: loginGoogle }, children));
};
